...
var myChartTop = echarts.init(document.getElementById('chartTop'), 'vintage');
...
var myChartNetwork = echarts.init(document.getElementById('network'), 'vintage');
  ...
  series: [
    {
      ...
      data: dataTimeSeries().data
    }
  ]
};

// myChartNetwork.showLoading();
ROOT_PATH = "assets\\data\\les-miserables.json"



$.getJSON(ROOT_PATH, function (graph) {
  // myChartNetwork.hideLoading();
  let option = {
    tooltip: {},
    legend: [
      {
...
myChartTop.setOption(optionsBar2);
myChart1.setOption(optionsBar);
myChart2.setOption(optionsTimeSeries);
myChart3.setOption(optionsScatter);
myChart4.setOption(optionPie);
